...
function quorum_Main_(parents) {
this.prototype = this;
this.parentNames_ = ['Libraries.Language.Object', 'Libraries.Game.Game',  'Main'];
...
this.Compare$quorum_Libraries_Language_Object = function(object) {
     return this.Libraries_Language_Object__.Compare$quorum_Libraries_Language_Object(object);
}
...
this.SetWebCanvasName$quorum_text = function(name) {
     return this.Libraries_Game_Game__.SetWebCanvasName$quorum_text(name);
}
...
this.GetAccessibilityManager = function() {
     return this.Libraries_Game_Game__.GetAccessibilityManager();
}
...
this.Equals$quorum_Libraries_Language_Object = function(object) {
     return this.Libraries_Language_Object__.Equals$quorum_Libraries_Language_Object(object);
}
...
this.SetAccessibilityManager$quorum_Libraries_Interface_AccessibilityManager = function(accessibilityManager) {
     return this.Libraries_Game_Game__.SetAccessibilityManager$quorum_Libraries_Interface_AccessibilityManager(accessibilityManager);
}
this.Main = function () {
this.prototype.StartGame();
};
this.CreateGame = function () {
var label = new quorum_Libraries_Game_Graphics_Label_();
label.SetText$quorum_text("Hello world!");
label.SetPosition$quorum_number$quorum_number(100 * 1.0, 100 * 1.0);
label.SetFontSize$quorum_integer(32);
this.prototype.Add$quorum_Libraries_Interface_Item2D(label);
};
...
if(parents == null) {
   this.Libraries_Language_Object__ = new quorum_Libraries_Language_Object_(false);
